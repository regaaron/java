...
public class zombies {
    ...
    zombies(Plantas p, int y,boolean bandera) {
        ...
        if(!bandera){
           velocidad = .5;  
            ...
            velocidad = 1;
        }// velocidad de .25 ya que se actualiza 30 veces por segundo
    ...
    public void draw(Graphics2D g2) {
        ...
        if(!bandera){
           ...
           if(realentiza){
                EfectoLento();
                g2.drawImage(buffer, (int) x, (int) y, p.pixel - 30, p.pixel - 30, p);

            }else{
                g2.drawImage(zoombie, (int) x, (int) y, p.pixel - 30, p.pixel - 30, p);
           }

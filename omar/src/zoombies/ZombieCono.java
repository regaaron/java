...
public class ZombieCono extends zombies{
    ZombieCono(Plantas p,int y,boolean bandera){
        super(p, y,bandera);
        this.vida=200;
    ...
    public void cargarImagenes() {
        String basePath = "/Java/imagenes/ZombieCono/frame_";
        String eatBasePath = "/Java/imagenes/ZombieCono_eat/frame_";
    ...
    public void draw(Graphics2D g2) {
        if(realentiza){
            EfectoLento();
            g2.drawImage(buffer, (int) x-40, (int) y, (int)(p.pixel*1.6), p.pixel, p);

        }else{
            g2.drawImage(zoombie, (int) x-40, (int) y, (int)(p.pixel*1.6), p.pixel, p);

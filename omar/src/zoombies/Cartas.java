...
public class Cartas extends JComponent implements Runnable{
    ...
    public boolean multijugador = true;
    
    Thread gameThread;
    //Constructor por defecto; asignamos todos los valores inciales de las cartas de los dos jugadores
    public Cartas(JFrame jf,int nivel,int ecenario,boolean bandera) throws Exception{
    ...
    public void nivel(){
        JFrame jf2 = new JFrame("Juego");
                ...
                Plantas demo2 = new Plantas(mazoplantas,nivel,ecenario,bandera);

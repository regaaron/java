...
public class ZombieEnano extends zombies{
    ZombieEnano(Plantas p, int y,boolean bandera){
        super(p, y,bandera);
        this.vida=50;
    ...
    public void cargarImagenes() {
        String basePath = "/Java/imagenes/ZombieEnano/frame_";
        String eatBasePath = "/Java/imagenes/ZombieEnano_eat/frame_";
    ...
    public void BarraVida(Graphics2D g2) {
        ...
        g2.fillRect((int) x, (int) y - 10, (int) (p.pixel * (vida / 50.0)), 5);
    }
